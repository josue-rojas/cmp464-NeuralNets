...
# (16,8)
first = tf.constant([random() for x in range(128)],name="sixteen-eight", shape=[16,8], dtype=tf.float32)
second = tf.constant([random() for x in range(32)],name="eight-four", shape=[8,4], dtype=tf.float32)
third = tf.constant([random() for x in range(8)],name="four-two", shape=[4,2], dtype=tf.float32)
fourth = tf.constant([random() for x in range(2)],name="two-one", shape=[2,1], dtype=tf.float32)
#
